...
public class JdbcDeleteDemo {
	...
	private static void displayEmployee(Connection myConn, String firstName, String lastName) throws SQLException {
		...
		try {
			// Prepare statement
			myStmt = myConn
					.prepareStatement("select last_name, first_name, phone_number from employees where last_name=? and first_name=?");
			...
			while (myRs.next()) {
				...
				String phoneNumber = myRs.getString("phone_numer");
			
				System.out.printf("Found employee: %s %s, %s\n", theFirstName, theLastName, phoneNumber);
				found=true;
			}
